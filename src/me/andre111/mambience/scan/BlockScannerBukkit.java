...
import me.andre111.mambience.util.MaterialNameUtil;
		...
		for(int xx=0; xx<xSize; xx++) {
			for(int zz=0; zz<zSize; zz++) {
				for(int yy=0; yy<currentYSize; yy++) {
					...
					//TODO: BUKKIT PLUGIN IS BROKEN: Need to convert from material to minecraft name
					//TODO: This will need to be updated for every new minecraft version
					String id = MaterialNameUtil.getInternalName(foundMat);
